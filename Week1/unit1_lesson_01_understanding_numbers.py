...
def test_numbers_arithmetic_operations():
    ...
    #>>> import math
    #>>> help(math.isclose)
    assert math.isclose(2.33, 7/3, abs_tol=2.3), "fix abs_tol so that this assert passes"
...
def test_numbers_base():
    ...
    assert 675 == int("100", 26) - int("1",26)
...
- How to use the different numeric types according to the purpose
- Using the python console constructively
